...
; ORIGIN:       https://github.com/ahumenberger/Aligator.jl/blob/master/benchmark/singlepath.jl
; INVARIANTS:   y^2*z + y*z*y00 - 2*z*y00^2 + 2*y^2*z00 - 3*z*x*z00 - y*y00*z00 - y00^2*z00 - 3*y*z00^2 - 3*x*z00^2 + 3*y00*z00^2 + 3*z*z00*x00 + 3*z00^2*x00 - 12*y*z - 18*y*x - 18*z*x + 36*y*y00 + 12*z*y00 + 18*x*y00 - 36*y00^2 + 6*y*z00 - 6*y00*z00 + 18*y*x00 + 18*z*x00 - 18*y00*x00 + 72*y + 108*x - 72*y00 - 108*x00
;
; SOURCECODE: 
;   while n<=N
;       n = n+1
