...
(assert
	(exists
		...
		(and
			...
			(= (- (+ (- (+ (- (+ (- (+ (- (* 6 (+ s (* 6 r) 3) (+ r 1) r00) (* 6 (+ r 1) s00 r00) (* 6 (+ s (* 6 r) 3) r00 r00)) (* 6 s00 r00 r00) (* 2 (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 9 (+ s (* 6 r) 3) (+ r 1))) (* 18 (+ r 1) (- x s)) (* 2 (+ s (* 6 r) 3) s00) (* 9 (+ r 1) s00)) (* 4 s00 s00) (* 9 (+ s (* 6 r) 3) r00)) (* 18 (- x s) r00) (* 9 s00 r00)) (* 18 (+ r 1) x00) (* 18 r00 x00)) (* 3 (+ s (* 6 r) 3))) (* 3 s00)) 0)
			(= (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (* 2 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ r 1)) (* 2 (+ s (* 6 r) 3) (+ r 1) s00)) (* 4 (+ r 1) s00 s00)) (* 4 (+ s (* 6 r) 3) (+ s (* 6 r) 3) r00) (* 36 (+ r 1) (- x s) r00)) (* 2 (+ s (* 6 r) 3) s00 r00) (* 2 s00 s00 r00) (* 36 (+ s (* 6 r) 3) r00 r00)) (* 36 (- x s) r00 r00) (* 36 s00 r00 r00)) (* 36 (+ r 1) r00 x00) (* 36 r00 r00 x00)) (* 3 (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 24 (+ s (* 6 r) 3) (+ r 1))) (* 6 (+ s (* 6 r) 3) (- x s)) (* 54 (+ r 1) (- x s)) (* 12 (+ s (* 6 r) 3) s00) (* 24 (+ r 1) s00)) (* 6 (- x s) s00) (* 15 s00 s00) (* 24 (+ s (* 6 r) 3) r00)) (* 54 (- x s) r00) (* 24 s00 r00)) (* 6 (+ s (* 6 r) 3) x00) (* 54 (+ r 1) x00)) (* 6 s00 x00)) (* 54 r00 x00)) (* 9 (+ s (* 6 r) 3))) (* 9 s00)) 0)
			(= (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (+ (- (* 36 (+ s (* 6 r) 3) (+ s (* 6 r) 3) r00 r00) (* 36 s00 s00 r00 r00) (* 216 (+ s (* 6 r) 3) r00 r00 r00)) (* 432 (- x s) r00 r00 r00) (* 216 s00 r00 r00 r00)) (* 432 r00 r00 r00 x00) (* 4 (+ s (* 6 r) 3) (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* 12 (+ s (* 6 r) 3) (+ s (* 6 r) 3) s00)) (* 16 s00 s00 s00) (* 108 (+ s (* 6 r) 3) s00 r00)) (* 216 (- x s) s00 r00) (* 108 s00 s00 r00)) (* 36 (+ s (* 6 r) 3) r00 r00)) (* 36 s00 r00 r00)) (* 216 s00 r00 x00) (* 15 (+ s (* 6 r) 3) (+ s (* 6 r) 3))) (* 108 (+ s (* 6 r) 3) (- x s))) (* 36 3 (- x s) (- x s))) (* 66 (+ s (* 6 r) 3) s00)) (* 36 3 (- x s) s00) (* 51 s00 s00) (* 54 (+ s (* 6 r) 3) r00)) (* 36 3 (- x s) r00) (* 54 s00 r00)) (* 108 (+ s (* 6 r) 3) x00)) (* 216 (- x s) x00) (* 108 s00 x00)) (* 108 r00 x00) (* 108 x00 x00)) (* 9 (+ s (* 6 r) 3))) (* 9 s00)) 0)
			(= (+ (- (* 3 (+ r 1) (+ r 1)) (* 3 r00 r00) (+ s (* 6 r) 3)) s00) 0)
			
			(not (= (+ (- (+ (- (* 12 (+ r 1) r00 r00) (* 12 r00 r00 r00) (* 2 (+ s (* 6 r) 3) (+ r 1)) (* 4 (+ r 1) s00)) (* 6 s00 r00) (* 3 (+ s (* 6 r) 3))) (* 3 (+ r 1)) (* 6 (- x s)) (* 3 s00)) (* 3 r00) (* 6 x00)) 0))
		)
	)
)
