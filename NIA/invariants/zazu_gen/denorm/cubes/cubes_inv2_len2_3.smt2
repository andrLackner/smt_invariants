...
; Benchmark: 		cubes_inv2_len2_3
; Created:   		2021-08-31 14:09
; Invariants: 
; 		 -6 + m - 6*n
; 		 4 - 18*c - 9*c*n - 5*k + 9*n + k^2
; 		 -3*c + k*n - k + 2*n
; 		 3*n^2 - k + 3*n
; 		 (4 - 18*c - 9*c*n - 5*k + 9*n + k^2) * (9*c*k^2*m^2 - 9*k*n)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (- 4 (* 18 (+ c k)) (* 9 (+ c k) (+ n 1)) (* 5 (+ k m))) (* 9 (+ n 1)) (* (+ k m) (+ k m))) (- (* 9 (+ c k) (+ k m) (+ k m) (+ m 6) (+ m 6)) (* 9 (+ k m) (+ n 1)))) 0))
			)
		)
	)
)
