...
; 		 -3*c + k*n - k + 2*n
; 		 3*n^2 - k + 3*n
; 		 (4 - 18*c - 9*c*n - 5*k + 9*n + k^2) * (9*c^2*k*m*n + 4*c + 8*c^2 + 7*k^2*m*n)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (- 4 (* 18 (+ c k)) (* 9 (+ c k) (+ n 1)) (* 5 (+ k m))) (* 9 (+ n 1)) (* (+ k m) (+ k m))) (+ (* 9 (+ c k) (+ c k) (+ k m) (+ m 6) (+ n 1)) (* 4 (+ c k)) (* 8 (+ c k) (+ c k)) (* 7 (+ k m) (+ k m) (+ m 6) (+ n 1)))) 0))
			)
		)
	)
)
