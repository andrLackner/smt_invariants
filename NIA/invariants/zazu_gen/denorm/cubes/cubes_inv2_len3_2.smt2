...
; 		 -3*c + k*n - k + 2*n
; 		 3*n^2 - k + 3*n
; 		 (4 - 18*c - 9*c*n - 5*k + 9*n + k^2) * (-c^2*k^2*n^2 - 6*n^2 - 3*c*k*n^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (- 4 (* 18 (+ c k)) (* 9 (+ c k) (+ n 1)) (* 5 (+ k m))) (* 9 (+ n 1)) (* (+ k m) (+ k m))) (- (* (- 1) (+ c k) (+ c k) (+ k m) (+ k m) (+ n 1) (+ n 1)) (* 6 (+ n 1) (+ n 1)) (* 3 (+ c k) (+ k m) (+ n 1) (+ n 1)))) 0))
			)
		)
	)
)
