...
; 		 -3*c + k*n - k + 2*n
; 		 3*n^2 - k + 3*n
; 		 (-3*c + k*n - k + 2*n) * (7*c^2*k*m*n - 5*c*k^2 + 8*c^2*k*m*n^2 + m^2*n)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (- (+ (* (- 3) (+ c k)) (* (+ k m) (+ n 1))) (+ k m)) (* 2 (+ n 1))) (+ (- (* 7 (+ c k) (+ c k) (+ k m) (+ m 6) (+ n 1)) (* 5 (+ c k) (+ k m) (+ k m))) (* 8 (+ c k) (+ c k) (+ k m) (+ m 6) (+ n 1) (+ n 1)) (* (+ m 6) (+ m 6) (+ n 1)))) 0))
			)
		)
	)
)
