...
; 		 -3*c + k*n - k + 2*n
; 		 3*n^2 - k + 3*n
; 		 (-3*c + k*n - k + 2*n) * (-c^2*k^2*n^2 - 6*n^2 - 3*c*k*n^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (- (+ (* (- 3) (+ c k)) (* (+ k m) (+ n 1))) (+ k m)) (* 2 (+ n 1))) (- (* (- 1) (+ c k) (+ c k) (+ k m) (+ k m) (+ n 1) (+ n 1)) (* 6 (+ n 1) (+ n 1)) (* 3 (+ c k) (+ k m) (+ n 1) (+ n 1)))) 0))
			)
		)
	)
)
