...
; 		 -3*c + k*n - k + 2*n
; 		 3*n^2 - k + 3*n
; 		 (3*n^2 - k + 3*n) * (9*c^2*k^2*n^2 + 9*c + 2*k - 3*c^2*m^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (- (* 3 (+ n 1) (+ n 1)) (+ k m)) (* 3 (+ n 1))) (- (+ (* 9 (+ c k) (+ c k) (+ k m) (+ k m) (+ n 1) (+ n 1)) (* 9 (+ c k)) (* 2 (+ k m))) (* 3 (+ c k) (+ c k) (+ m 6) (+ m 6)))) 0))
			)
		)
	)
)
