...
; 		 -3*c + k*n - k + 2*n
; 		 3*n^2 - k + 3*n
; 		 (-3*c + k*n - k + 2*n) * (-7*c^2*k*m + 9*c^2*m^2*n + 2*k^2*m*n)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (- (+ (* (- 3) (+ c k)) (* (+ k m) (+ n 1))) (+ k m)) (* 2 (+ n 1))) (+ (* (- 7) (+ c k) (+ c k) (+ k m) (+ m 6)) (* 9 (+ c k) (+ c k) (+ m 6) (+ m 6) (+ n 1)) (* 2 (+ k m) (+ k m) (+ m 6) (+ n 1)))) 0))
			)
		)
	)
)
