...
; Benchmark: 		cohencu_inv2_len3_2
; Created:   		2021-08-30 22:45
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2) * (-x^2*y^2*z^2 + 9*n*x^2*y^2 - 3*n*x*y)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6))) (- (+ (* (- 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 9 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z))) (* 3 (+ n 1) (+ x y) (+ y z)))) 0))
			)
		)
	)
)
