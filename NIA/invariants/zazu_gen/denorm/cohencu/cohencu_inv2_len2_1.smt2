...
; Benchmark: 		cohencu_inv2_len2_1
; Created:   		2021-08-30 18:20
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (2*n*x*y*z + 10*n*x^2*y*z^2) * (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (* 2 (+ n 1) (+ x y) (+ y z) (+ z 6)) (* 10 (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
