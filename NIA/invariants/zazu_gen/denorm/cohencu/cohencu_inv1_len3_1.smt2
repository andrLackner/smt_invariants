...
; Benchmark: 		cohencu_inv1_len3_1
; Created:   		2021-08-30 22:40
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (-2*n^2*x^2*y^2*z - 3*y*z - 10*n*x*y*z^2) * (-z + z00 + 6*n - 6*n00)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (* (- 2) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* 3 (+ y z) (+ z 6)) (* 10 (+ n 1) (+ x y) (+ y z) (+ z 6) (+ z 6))) (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00))) 0))
			)
		)
	)
)
