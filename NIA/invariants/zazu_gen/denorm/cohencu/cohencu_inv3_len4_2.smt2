...
; Benchmark: 		cohencu_inv3_len4_2
; Created:   		2021-08-30 23:14
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (7*y*z + 5*n*x^2*y^2*z^2 + 6*n^2*x^2*y*z^2 - 10*n*x*y^2*z) * (-6*y*z - z00^3 + 6*z00^2 - 12*y00*z + 18*y00*z00 + 108*x - 72*y00 - 6*z*z00 + 72*y - 108*x00 + z*z00^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (+ (* 7 (+ y z) (+ z 6)) (* 5 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 10 (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6))) (+ (- (+ (- (+ (- (+ (- (* (- 6) (+ y z) (+ z 6)) (* z00 z00 z00)) (* 6 z00 z00)) (* 12 y00 (+ z 6))) (* 18 y00 z00) (* 108 (+ x y))) (* 72 y00) (* 6 (+ z 6) z00)) (* 72 (+ y z))) (* 108 x00)) (* (+ z 6) z00 z00))) 0))
			)
		)
	)
)
