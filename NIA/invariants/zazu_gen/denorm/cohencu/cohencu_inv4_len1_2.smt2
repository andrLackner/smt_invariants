...
; Benchmark: 		cohencu_inv4_len1_2
; Created:   		2021-08-30 18:09
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (9*x^2*y^2) * (-y00*z*z00 - 12*y*z - 18*x*z + 18*x00*z00 + 12*y^2 - 24*y00^2 + 18*x00*z + 12*y00*z + 6*y00*z00 + 12*y*y00 + 108*x - 72*y00 - 6*y*z00 + 72*y - 108*x00 + y00*z00^2 - 18*x*z00 + y*z*z00 - y*z00^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* 9 (+ x y) (+ x y) (+ y z) (+ y z) (- (+ (- (+ (- (+ (- (+ (- (+ (- (* (- 1) y00 (+ z 6) z00) (* 12 (+ y z) (+ z 6)) (* 18 (+ x y) (+ z 6))) (* 18 x00 z00) (* 12 (+ y z) (+ y z))) (* 24 y00 y00)) (* 18 x00 (+ z 6)) (* 12 y00 (+ z 6)) (* 6 y00 z00) (* 12 (+ y z) y00) (* 108 (+ x y))) (* 72 y00) (* 6 (+ y z) z00)) (* 72 (+ y z))) (* 108 x00)) (* y00 z00 z00)) (* 18 (+ x y) z00)) (* (+ y z) (+ z 6) z00)) (* (+ y z) z00 z00))) 0))
			)
		)
	)
)
