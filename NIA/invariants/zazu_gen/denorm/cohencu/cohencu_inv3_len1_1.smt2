...
; 		 (4*n*z^2) * (-6*y*z - z00^3 + 6*z00^2 - 12*y00*z + 18*y00*z00 + 108*x - 72*y00 - 6*z*z00 + 72*y - 108*x00 + z*z00^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* 4 (+ n 1) (+ z 6) (+ z 6) (+ (- (+ (- (+ (- (+ (- (* (- 6) (+ y z) (+ z 6)) (* z00 z00 z00)) (* 6 z00 z00)) (* 12 y00 (+ z 6))) (* 18 y00 z00) (* 108 (+ x y))) (* 72 y00) (* 6 (+ z 6) z00)) (* 72 (+ y z))) (* 108 x00)) (* (+ z 6) z00 z00))) 0))
			)
		)
	)
)
