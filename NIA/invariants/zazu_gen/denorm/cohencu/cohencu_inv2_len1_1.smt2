...
; Benchmark: 		cohencu_inv2_len1_1
; Created:   		2021-08-30 18:01
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (4*n*z^2) * (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* 4 (+ n 1) (+ z 6) (+ z 6) (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
