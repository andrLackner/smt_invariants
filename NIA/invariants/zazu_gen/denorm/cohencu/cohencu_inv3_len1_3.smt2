...
; Benchmark: 		cohencu_inv3_len1_3
; Created:   		2021-08-30 18:07
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (8*x*y^2) * (-6*y*z - z00^3 + 6*z00^2 - 12*y00*z + 18*y00*z00 + 108*x - 72*y00 - 6*z*z00 + 72*y - 108*x00 + z*z00^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* 8 (+ x y) (+ y z) (+ y z) (+ (- (+ (- (+ (- (+ (- (* (- 6) (+ y z) (+ z 6)) (* z00 z00 z00)) (* 6 z00 z00)) (* 12 y00 (+ z 6))) (* 18 y00 z00) (* 108 (+ x y))) (* 72 y00) (* 6 (+ z 6) z00)) (* 72 (+ y z))) (* 108 x00)) (* (+ z 6) z00 z00))) 0))
			)
		)
	)
)
