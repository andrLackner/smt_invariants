...
; Benchmark: 		cohencu_inv1_len4_2
; Created:   		2021-08-30 23:08
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (7*y*z + 5*n*x^2*y^2*z^2 + 6*n^2*x^2*y*z^2 - 10*n*x*y^2*z) * (-z + z00 + 6*n - 6*n00)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (+ (* 7 (+ y z) (+ z 6)) (* 5 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6) (+ z 6))) (* 10 (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6))) (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00))) 0))
			)
		)
	)
)
