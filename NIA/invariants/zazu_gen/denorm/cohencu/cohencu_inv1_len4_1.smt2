...
; 		 (-5*n*y^2*z^2 + n*x*y^2*z^2 + 2*n^2*x^2*y*z + 7*x) * (-z + z00 + 6*n - 6*n00)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (* (- 5) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 2 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6)) (* 7 (+ x y))) (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00))) 0))
			)
		)
	)
)
