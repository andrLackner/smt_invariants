...
; Benchmark: 		cohencu_inv1_len3_3
; Created:   		2021-08-30 22:42
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (-5*n^2*x^2*y - 10*n^2*x*z^2 - 5*n*x^2*z) * (-z + z00 + 6*n - 6*n00)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (* (- 5) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z)) (* 10 (+ n 1) (+ n 1) (+ x y) (+ z 6) (+ z 6)) (* 5 (+ n 1) (+ x y) (+ x y) (+ z 6))) (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00))) 0))
			)
		)
	)
)
