...
; Benchmark: 		cohencu_inv1_len2_3
; Created:   		2021-08-30 18:19
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (9*y*z - n^2*x^2*y^2*z) * (-z + z00 + 6*n - 6*n00)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (* 9 (+ y z) (+ z 6)) (* (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6))) (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00))) 0))
			)
		)
	)
)
