...
; Benchmark: 		cohencu_inv1_len3_2
; Created:   		2021-08-30 22:41
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (-x^2*y^2*z^2 + 9*n*x^2*y^2 - 3*n*x*y) * (-z + z00 + 6*n - 6*n00)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (+ (* (- 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 9 (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z))) (* 3 (+ n 1) (+ x y) (+ y z))) (- (+ (* (- 1) (+ z 6)) z00 (* 6 (+ n 1))) (* 6 n00))) 0))
			)
		)
	)
)
