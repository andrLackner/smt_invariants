...
; 		 (-5*n*y^2*z^2 + n*x*y^2*z^2 + 2*n^2*x^2*y*z + 7*x) * (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (* (- 5) (+ n 1) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* (+ n 1) (+ x y) (+ y z) (+ y z) (+ z 6) (+ z 6)) (* 2 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ z 6)) (* 7 (+ x y))) (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
