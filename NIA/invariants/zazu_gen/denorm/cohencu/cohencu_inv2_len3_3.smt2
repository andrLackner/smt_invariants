...
; Benchmark: 		cohencu_inv2_len3_3
; Created:   		2021-08-30 22:46
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2) * (-5*n^2*x^2*y - 10*n^2*x*z^2 - 5*n*x^2*z)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6))) (- (* (- 5) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z)) (* 10 (+ n 1) (+ n 1) (+ x y) (+ z 6) (+ z 6)) (* 5 (+ n 1) (+ x y) (+ x y) (+ z 6)))) 0))
			)
		)
	)
)
