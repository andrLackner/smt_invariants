...
; Benchmark: 		cohencu_inv2_len2_2
; Created:   		2021-08-30 18:21
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (6*n^2*x^2*y + x^2*y) * (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (* 6 (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z)) (* (+ x y) (+ x y) (+ y z))) (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
