...
; Benchmark: 		cohencu_inv2_len2_3
; Created:   		2021-08-30 18:22
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (-n^2*x^2*y^2*z + 9*y*z) * (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (+ (* (- 1) (+ n 1) (+ n 1) (+ x y) (+ x y) (+ y z) (+ y z) (+ z 6)) (* 9 (+ y z) (+ z 6))) (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
