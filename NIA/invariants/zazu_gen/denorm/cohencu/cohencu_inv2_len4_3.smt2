...
; Benchmark: 		cohencu_inv2_len4_3
; Created:   		2021-08-30 23:12
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (5*n^2*x^2 + 7*y*z + 2*x^2*z^2 - 6*n^2*y*z^2) * (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (+ (* 5 (+ n 1) (+ n 1) (+ x y) (+ x y)) (* 7 (+ y z) (+ z 6)) (* 2 (+ x y) (+ x y) (+ z 6) (+ z 6))) (* 6 (+ n 1) (+ n 1) (+ y z) (+ z 6) (+ z 6))) (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
