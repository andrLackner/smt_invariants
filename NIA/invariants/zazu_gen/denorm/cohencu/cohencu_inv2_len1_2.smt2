...
; Benchmark: 		cohencu_inv1_len1_2
; Created:   		2021-08-30 18:03
; Invariants: 
; 		 -z + z00 + 6*n - 6*n00
...
; 		 (9*x^2*y^2) * (-z00^2 + 12*y00 - 12*y - 6*z + 6*z00 + z^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* 9 (+ x y) (+ x y) (+ y z) (+ y z) (+ (- (+ (* (- 1) z00 z00) (* 12 y00)) (* 12 (+ y z)) (* 6 (+ z 6))) (* 6 z00) (* (+ z 6) (+ z 6)))) 0))
			)
		)
	)
)
