...
; 		 (s00 - s + 3*r^2 - 3*r00^2) * (-x + 6*r^2*s*x^2 - 6*r^2*s^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (+ (- s00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 r00 r00)) (- (+ (* (- 1) (- x s)) (* 6 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s))) (* 6 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3)))) 0))
			)
		)
	)
)
