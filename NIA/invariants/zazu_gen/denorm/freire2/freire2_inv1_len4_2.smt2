...
; 		 (s00 - s + 3*r^2 - 3*r00^2) * (-4 + 2*x + 8*r^2*s*x^2 - 8*r*s^2*x^2)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (+ (- s00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 r00 r00)) (- (+ (- 4) (* 2 (- x s)) (* 8 (+ r 1) (+ r 1) (+ s (* 6 r) 3) (- x s) (- x s))) (* 8 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s) (- x s)))) 0))
			)
		)
	)
)
