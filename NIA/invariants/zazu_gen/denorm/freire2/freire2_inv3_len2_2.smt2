...
; Benchmark: 		freire2_inv3_len2_2
; Created:   		2021-08-31 15:20
; Invariants: 
; 		 s00 - s + 3*r^2 - 3*r00^2
...
; 		 (-9*r*s - 18*r00*x00 + 9*r00*s00 + 2*s^2 + 18*r*x + 6*r*r00*s - 6*r00^2*s - 4*s00^2 + 18*r00*x - 3*s00 + 6*r00^2*s00 - 18*r*x00 + 3*s + 9*r*s00 + 2*s*s00 - 9*r00*s - 6*r*r00*s00) * (2*r^2 - 4*r*s^2*x)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (+ (- (+ (- (+ (- (+ (- (* (- 9) (+ r 1) (+ s (* 6 r) 3)) (* 18 r00 x00)) (* 9 r00 s00) (* 2 (+ s (* 6 r) 3) (+ s (* 6 r) 3)) (* 18 (+ r 1) (- x s)) (* 6 (+ r 1) r00 (+ s (* 6 r) 3))) (* 6 r00 r00 (+ s (* 6 r) 3)) (* 4 s00 s00)) (* 18 r00 (- x s))) (* 3 s00)) (* 6 r00 r00 s00)) (* 18 (+ r 1) x00)) (* 3 (+ s (* 6 r) 3)) (* 9 (+ r 1) s00) (* 2 (+ s (* 6 r) 3) s00)) (* 9 r00 (+ s (* 6 r) 3)) (* 6 (+ r 1) r00 s00)) (- (* 2 (+ r 1) (+ r 1)) (* 4 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)))) 0))
			)
		)
	)
)
