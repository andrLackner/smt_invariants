...
; 		 (s00 - s + 3*r^2 - 3*r00^2) * (10 - 9*r*s*x - 3*r^2*x^2 - 3*r*s^2*x)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (+ (- s00 (+ s (* 6 r) 3)) (* 3 (+ r 1) (+ r 1))) (* 3 r00 r00)) (- 10 (* 9 (+ r 1) (+ s (* 6 r) 3) (- x s)) (* 3 (+ r 1) (+ r 1) (- x s) (- x s)) (* 3 (+ r 1) (+ s (* 6 r) 3) (+ s (* 6 r) 3) (- x s)))) 0))
			)
		)
	)
)
