...
; 		 (-2*r*s + 12*r*r00^2 - 3*r - 3*s00 + 3*s + 3*r00 - 4*r*s00 + 6*r00*s00 - 6*x + 6*x00 - 12*r00^3) * (-r^2*s)
;--------------------------------------------------------------------------
	...
	(exists
		...
		(and
			...
			(or
				...
				(not (= (* (- (+ (- (+ (- (+ (- (+ (* (- 2) (+ r 1) (+ s (* 6 r) 3)) (* 12 (+ r 1) r00 r00)) (* 3 (+ r 1)) (* 3 s00)) (* 3 (+ s (* 6 r) 3)) (* 3 r00)) (* 4 (+ r 1) s00)) (* 6 r00 s00)) (* 6 (- x s))) (* 6 x00)) (* 12 r00 r00 r00)) (- 1) (+ r 1) (+ r 1) (+ s (* 6 r) 3)) 0))
			)
		)
	)
)
