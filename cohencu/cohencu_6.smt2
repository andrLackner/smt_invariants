...
; contradiction
(assert (not (= (- (* (* (* (+ y z) (+ y z)) z00) z00) (- (* (* (* y00 y00) z00) z00) (- (* (* (* (+ y z) z00) z00) z00) (+ (* (* (* (* 2 (+ x y)) z00) z00) z00) (+ (* (* (* y00 z00) z00) z00) (- (* (* (* (* 2 z00) z00) z00) x00) (- (* (* (* 4 (+ y z)) (+ y z)) (+ y z)) (+ (* (* (* 12 (+ y z)) (+ y z)) y00) (- (* (* (* 16 y00) y00) y00) (+ (* (* (* 6 (+ y z)) (+ y z)) z00) (+ (* (* (* 18 (+ y z)) y00) z00) (- (* (* (* 36 (+ x y)) y00) z00) (+ (* (* (* 12 y00) y00) z00) (+ (* (* (* 10 (+ y z)) z00) z00) (- (* (* (* 18 (+ x y)) z00) z00) (- (* (* (* 10 y00) z00) z00) (- (* (* (* 36 y00) z00) x00) (+ (* (* (* 18 z00) z00) x00) (+ (* (* 24 (+ y z)) (+ y z)) (+ (* (* 108 (+ y z)) (+ x y)) (- (* (* 108 (+ x y)) (+ x y)) (- (* (* 120 (+ y z)) y00) (+ (* (* 216 (+ x y)) y00) (- (* (* 96 y00) y00) (- (* (* 24 (+ y z)) z00) (+ (* (* 36 (+ x y)) z00) (- (* (* 24 y00) z00) (- (* (* 108 (+ y z)) x00) (+ (* (* 216 (+ x y)) x00) (+ (* (* 216 y00) x00) (+ (* (* 36 z00) x00) (* (* 108 x00) x00)))))))))))))))))))))))))))))))) 0)))
(check-sat)
(exit)