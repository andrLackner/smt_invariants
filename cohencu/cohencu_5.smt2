...
; contradiction
(assert (not (= (+ (* (* (+ y z) (+ y z)) (+ z 6)) (- (* (* (+ y z) (+ z 6)) y00) (+ (* (* (* 2 (+ z 6)) y00) y00) (- (* (* (* 2 (+ y z)) (+ y z)) z00) (- (* (* (* 3 (+ z 6)) (+ x y)) z00) (- (* (* (+ y z) y00) z00) (- (* (* y00 y00) z00) (- (* (* (* 3 (+ y z)) z00) z00) (+ (* (* (* 3 (+ x y)) z00) z00) (+ (* (* (* 3 y00) z00) z00) (+ (* (* (* 3 (+ z 6)) z00) x00) (- (* (* (* 3 z00) z00) x00) (- (* (* 12 (+ y z)) (+ z 6)) (- (* (* 18 (+ y z)) (+ x y)) (+ (* (* 18 (+ z 6)) (+ x y)) (+ (* (* 36 (+ y z)) y00) (+ (* (* 12 (+ z 6)) y00) (- (* (* 18 (+ x y)) y00) (+ (* (* 36 y00) y00) (- (* (* 6 (+ y z)) z00) (+ (* (* 6 y00) z00) (+ (* (* 18 (+ y z)) x00) (- (* (* 18 (+ z 6)) x00) (+ (* (* 18 y00) x00) (+ (* 72 (+ y z)) (- (* 108 (+ x y)) (- (* 72 y00) (* 108 x00)))))))))))))))))))))))))))) 0)))
(check-sat)
(exit)