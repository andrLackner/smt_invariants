...
(assert (not (= (- (* (* (+ y z) (+ z 6)) z00) (- (* (* (+ z 6) y00) z00) (+ (* (* (+ y z) z00) z00) (+ (* (* y00 z00) z00) (- (* (* 12 (+ y z)) (+ y z)) (- (* (* 12 (+ y z)) (+ z 6)) (+ (* (* 18 (+ z 6)) (+ x y)) (+ (* (* 12 (+ y z)) y00) (- (* (* 12 (+ z 6)) y00) (- (* (* 24 y00) y00) (- (* (* 6 (+ y z)) z00) (+ (* (* 18 (+ x y)) z00) (+ (* (* 6 y00) z00) (+ (* (* 18 (+ z 6)) x00) (+ (* (* 18 z00) x00) (+ (* 72 (+ y z)) (- (* 108 (+ x y)) (- (* 72 y00) (* 108 x00))))))))))))))))))) 0)))
...
; contradiction
(assert (not (= (- (* (+ z 6) (+ z 6)) (- (* z00 z00) (- (* 12 (+ y z)) (+ (* 6 (+ z 6)) (+ (* 12 y00) (* 6 z00)))))) 0)))
