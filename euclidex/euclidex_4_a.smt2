...
(assert (= (- (* (- p q) s) (- (* q (- r s)) (+ (* p00 s00) (* q00 r00)))) 0))
(assert (= (- (* (- a b) s) (- (* b (- r s)) (+ (* a00 s00) (* b00 r00)))) 0))
(assert (= (- (* b (- p q)) (- (* (- a b) q) (+ (* b00 p00) (* a00 q00)))) 0))
(assert (= (+ (* (* (- r s) b00) p00) (- (* (* (- p q) a00) s00) (- (* (* (- a b) p00) s00) (- (* (* (- r s) a00) q00) (+ (* (* (- p q) b00) r00) (* (* (- a b) q00) r00)))))) 0))

; contradiction
(assert (not (= (+ (* (* s b00) p00) (- (* (* q a00) s00) (- (* (* b p00) s00) (- (* (* s a00) q00) (+ (* (* q b00) r00) (* (* b q00) r00)))))) 0)))
