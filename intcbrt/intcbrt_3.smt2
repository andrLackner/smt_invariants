...
(assert (not (= (- (* (* (+ s (+ (* 6 r) 3)) (+ r 1)) r00) (- (* (* (+ r 1) s00) r00) (+ (* (* (+ s (+ (* 6 r) 3)) r00) r00) (+ (* (* s00 r00) r00) (- (* (* (/ 1 3) (+ s (+ (* 6 r) 3))) (+ s (+ (* 6 r) 3))) (+ (* (* (/ 3 2) (+ s (+ (* 6 r) 3))) (+ r 1)) (+ (* (* 3 (+ r 1)) (- x s)) (+ (* (* (/ 1 3) (+ s (+ (* 6 r) 3))) s00) (- (* (* (/ 3 2) (+ r 1)) s00) (- (* (* (/ 2 3) s00) s00) (+ (* (* (/ 3 2) (+ s (+ (* 6 r) 3))) r00) (+ (* (* 3 (- x s)) r00) (- (* (* (/ 3 2) s00) r00) (- (* (* 3 (+ r 1)) x00) (+ (* (* 3 r00) x00) (- (* (/ 1 2) (+ s (+ (* 6 r) 3))) (* (/ 1 2) s00))))))))))))))))) 0)))
(check-sat)
(exit)